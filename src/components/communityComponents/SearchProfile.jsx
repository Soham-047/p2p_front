...
const SearchProfile = ({ open, onOpenChange, username }) => {
  ...
  const handleViewPostsClick = () => {
    ...
    navigate(`/users/${profile.username}`); // Navigate to the posts page
  };
                ...
                <div className="pt-4">
                  <div className="flex justify-between items-start">
                    ...
                    <Button
                      ...
                      className="rounded-full bg-purple-600 text-white px-6 py-2 hover:bg-purple-700 transition-colors"
                    >
                      View Posts
                    </Button>
